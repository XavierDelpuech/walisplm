...
#'     DO NOT REMOVE.
#' @import shiny
#' @importFrom ggplot2 aes geom_line geom_col scale_y_continuous theme_minimal xlab sec_axis geom_vline ggtitle facet_grid
#' @noRd
app_server <- function(input, output, session) {
  # Your application server logic
  #browser() ## permet d'arreter le code pour debogage
  #  mod_ModeleWaLIS_server("ModeleWaLIS_1")
  ## source model Kmax
#  mod_ModeleKmax_server("ModeleKmax_1")
  #
